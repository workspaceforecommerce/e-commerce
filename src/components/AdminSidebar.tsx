...
import {
  ...
  Sparkles, MessageSquare, Activity, Images, Tag, Ticket, CreditCard, Truck, RotateCcw, FileText, HelpCircle, Award, BarChart3, Layout, BookOpen, Megaphone, TrendingUp
} from 'lucide-react';
...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({ activeTab, setActiveTab, onLogout }) => {
  ...
  const menuItems = [
    ...
    { id: 'customer-analytics', label: 'Customer Analytics & Segments', icon: BarChart3 },
    { id: 'loyalty', label: 'Loyalty, Wallet & Rewards', icon: Award },
    ...
    { id: 'marketing-campaigns', label: 'Banners, Popups & Campaigns', icon: Megaphone },
    { id: 'seo', label: 'SEO, Sitemap & Redirects', icon: TrendingUp },
    ...
    { id: 'invoices-notifications', label: 'Invoices & Notifications', icon: FileText },
